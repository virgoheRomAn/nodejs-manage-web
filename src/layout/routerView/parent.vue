<template>
	<div class="layout-parent">
		<router-view v-slot="{ Component, route }" :key="route.fullpath">
			<transition :name="setTransitionName" mode="out-in" @enter="onEnter" @leave="onLeave">
		...
		<div class="app-loading transparent" v-show="isTranstion">
	...
	nextTick(() => {
		setTimeout(() => {
			if (themeConfig.value.isCacheTagsView) {
				let tagsViewArr: RouteItem[] = storage.get('tagsViewList') || [];
